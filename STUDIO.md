# Void Wars: Ash Run — studio lane

**Repo:** `black-market-survivor` (Next.js; includes Ash Run–oriented work).
...
- [../blood-arena-prototype/STUDIO.md](../blood-arena-prototype/STUDIO.md) — Blood Arena (PvP)

## Studio root

- [../../README.md](../../README.md) — Game Studio hub
- [../../WORKFLOW.md](../../WORKFLOW.md) — cross-game workflow
- [../../totalsurvivor.txt](../../totalsurvivor.txt) — design dump at studio level (optional reference)
